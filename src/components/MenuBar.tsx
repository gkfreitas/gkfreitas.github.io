...
export default function MenuBar(props: MenuBarProps) {
  ...
  return (
      ...
      <ul className={`overflow-hidden text-center border-b pb-[10px] dark:border-[#404040] border-[#DDD6FE] sm:hidden ${props.display ? 'block duration-300 h-[140px]' : 'h-0 duration-300'} `}>
        {links.map((link) => (
